 ...
 * 异常:状态码/描述信息 --字典类.<br>
 * 后期可实现i18n的国际化.<br>
 * Class name's simplify as: User-Defined Exception Enum ---> UDExceptionEnum
 */
public enum UDExceptionEnum {
    ...
    private UDExceptionEnum() {
    }

    private UDExceptionEnum(int code, String message) {
        this.code = code;
